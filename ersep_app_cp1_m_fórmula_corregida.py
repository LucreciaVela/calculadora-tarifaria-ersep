...
# Constantes desde el modelo Excel
Hn = 192
SHm = 5445.3036
IL = 1.2308
ITDm = 1.0667
...
if st.button("🔍 Calcular Cp1 (m)"):
    resultado = calcular_cp1_m(RTM, Pm)
    ...
    df = pd.DataFrame([{
        "Código": "Cp1(m)",
        "Ítem de costo": "Cp1 (m) – Subcomponente de A1 con fórmula corregida",
    ...
    st.download_button(
        ...
        file_name="Cp1_m_Fórmula_Corregida.xlsx",
