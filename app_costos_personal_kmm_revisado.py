...
datos["PartM"] = st.number_input("PartM - % Participación de unidades afectadas al servicio metropolitano", step=0.01)
...
if st.button("Calcular Costos Personal (Metropolitanas)"):
    try:
        ...
        km_m = (datos["RTM"] * datos["Pm"]) / (datos["Ut"] * datos["PartM"])

        Cp1 = (datos["Pm"] * Hn * SHm * ITDm * Ccm) / km_m
