...
# Datos fijos según hoja "Hoja Llave"
Hn = 192
SHm = 5445.3036
IL = 1.2308
ITDm = 1.0667
...
# Interfaz visual
st.set_page_config(page_title="ERSeP Cp1(m) Real", layout="wide")
st.title("🚌 Cálculo de Cp1 (m) – Horas Hombre del Personal de Conducción")
st.markdown("#### Cálculo con fórmula real validada y valores del archivo Excel")
...
if st.button("🔍 Calcular Cp1 (m)"):
    ...
    resultado_fmt = f"{resultado:,.6f}".replace(",", "X").replace(".", ",").replace("X", ".")
    ...
    st.download_button(
        ...
        file_name="Cp1_m_Resultado_Validado.xlsx",
