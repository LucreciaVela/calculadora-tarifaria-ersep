...
# Diccionario con descripciones para campos de ingreso
...
if st.button("🔍 Calcular y mostrar resultados"):
    ...
    # Reemplazar títulos de subtotales
    reemplazos = {
    ...
    st.success("✅ Cálculo y tabla generada correctamente.")
    ...
    st.download_button(
        ...
        file_name="Resumen_Tarifario_ERSEP_Final.xlsx",
